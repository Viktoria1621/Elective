...
public class CourseDAOImpl implements CourseDAO {
    ...
    private static final String FIND_COURSE_BY_TEACHER_REQUEST = "SELECT * FROM courses WHERE teachers_id = ?";
    ...
    @Override
    public List<Course> findCourseByTeacher(int id) throws DAOException {
        Connection con = null;
        PreparedStatement ps = null;
        ResultSet rs;
        ...
        try {
            con = connectionPool.takeConnection();
            ps = con.prepareStatement(FIND_COURSE_BY_TEACHER_REQUEST);
