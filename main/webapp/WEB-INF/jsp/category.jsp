...
<c:forEach var="category" items="${requestScope.categories}">
    <h3 align="center"><a href="Controller?command=ShowCoursesByCategory&categoryID=${category.categoryID}" class="animated-button"><c:out value="${category.categoryTitle}"/></a></h3>
</c:forEach>
<br>
