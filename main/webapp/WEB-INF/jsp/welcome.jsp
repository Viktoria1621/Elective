...
<c:if test="${sessionScope.user.roleID eq 2 or sessionScope.user.roleID eq 3}">
    <a href="Controller?command=GO_TO_PROFILE_PAGE" class="profile-button">Profile</a>
</c:if>
<c:if test="${not empty sessionScope.user}">
    <a href="Controller?command=GO_TO_SIGN_OUT_PAGE" class="sign-out-button">Sign out</a>
</c:if>
